...
<link rel="icon" type="image/png"
	href="assetsquantri/img/LOGOTHE5IVE.jpg" />
<!--===============================================================================================-->
...
if (user != null) {
	...
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			<div class="flex-w flex-sb-m p-b-52">
				...
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					<a href="Cuahang"
						class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 <%="".equals(request.getAttribute("currentLoai")) ? "how-active1" : ""%>">
						Tất cả </a>
					<%
					for (DanhMuc d : listDanhMuc) {
					%>
					<a
						href="Cuahang?loai=<%=d.getTenDanhMuc().equals("Nữ")
		? "nu"
		: d.getTenDanhMuc().equals("Nam") ? "nam" : d.getTenDanhMuc().equals("Túi") ? "tui" : "giay"%>"
		...
		|| (d.getTenDanhMuc().equals("Giày") && "giay".equals(request.getAttribute("currentLoai")))
				? "how-active1"
				: ""%>">
						<%=d.getTenDanhMuc()%>
					</a>
				...
				<div class="dis-none panel-filter w-full p-t-10">
					<div
						...
						<div class="filter-col1col1 p-r-15 p-b-27 pl-4">
							...
							<ul>
								<li class="p-b-6"><a
									href="Cuahang?loai=<%=request.getAttribute("currentLoai")%><%=request.getAttribute("currentMau") != null ? "&mau=" + request.getAttribute("currentMau") : ""%>"
								...
								%>
								<li class="p-b-6"><a
									href="Cuahang?loai=<%=request.getAttribute("currentLoai")%>&gia=<%=g%><%=request.getAttribute("currentMau") != null ? "&mau=" + request.getAttribute("currentMau") : ""%>"
