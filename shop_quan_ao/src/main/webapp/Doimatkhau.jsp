    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background-color: #f1f1f1; /* Nền nhẹ nhàng */
            color: #333;
            line-height: 1.6;
            padding: 0;
            margin: 0;
        ...
        .form-group input:focus {
            border-color: #56cfe1; /* Màu xanh nhạt khi focus */
        ...
        .btn {
            width: 100%;
            padding: 14px;
            background-color: #56cfe1; /* Màu xanh nhẹ */
            border: none;
            border-radius: 8px;
            color: #fff;
            font-size: 1rem;
        ...
        .btn:hover {
            background-color: #009c99; /* Màu xanh đậm khi hover */
        }
